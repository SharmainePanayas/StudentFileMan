...
<html lang = "en">
	<head>
		<title>Student | Student File Management System</title>
		<meta charset = "utf-8" />
...
<body>
<nav class="navbar navbar-default navbar-fixed-top text-monospace" style="background-color:#ffd700;">
		<div class="container-fluid">
		<label class="navbar-brand" style="color:black;" id="title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30"><path d="M12 2.5a5.25 5.25 0 00-2.519 9.857 9.005 9.005 0 00-6.477 8.37.75.75 0 00.727.773H20.27a.75.75 0 00.727-.772 9.005 9.005 0 00-6.477-8.37A5.25 5.25 0 0012 2.5z"></path></svg> Student | Student File Management System</label>
		</div>
	</nav>
	<div class="col-md-4 text-monospace">
		<?php
		...
		<div class="panel panel-default" style="background-color:#393f4d;" id="panel-margin">
			<div class="panel-heading" style="background-color:#ffd700;">
				<center><h1 class="panel-title" style="color:black;">Student Profile</h1></center>
			</div>
